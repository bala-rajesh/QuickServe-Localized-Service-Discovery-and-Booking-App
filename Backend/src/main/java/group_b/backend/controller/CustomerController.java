...
public class CustomerController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<SearchResultDto>> searchServiceProviders(@RequestParam(required = false, defaultValue = "") String query) {
    ...
    public ResponseEntity<BookingDto> rescheduleBooking(@PathVariable Long bookingId, @RequestBody RescheduleBookingRequestDto requestDto) {
